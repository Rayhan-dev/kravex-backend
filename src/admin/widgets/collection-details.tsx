...
const detailsFormSchema = z.object({
  image: imageFieldSchema().nullish(),
  description: z.string().optional(),
  collection_page_image: imageFieldSchema().nullish(),
  collection_page_heading: z.string().optional(),
  collection_page_content: z.string().optional(),
  product_page_heading: z.string().optional(),
  product_page_image: imageFieldSchema().nullish(),
  product_page_wide_image: imageFieldSchema().nullish(),
  product_page_cta_image: imageFieldSchema().nullish(),
